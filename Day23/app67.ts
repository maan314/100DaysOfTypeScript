...
function numberAndString(num1: number, numberText: string): number {
       return num1 + Number(numberText);
}

console.log(numberAndString(23, "5"));
//string converts into number and the result will be in number;
